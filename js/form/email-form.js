(function () {
  ...
  Promise.all([
    ...
    loadScript(`https://cdn.jsdelivr.net/gh/unicornixa/tss-wf@803f3eb/js/logic/zip-targeting.js`),
    loadScript(`${BASE}/logic/zip-dropdown.js`),
    loadScript(`https://cdn.jsdelivr.net/gh/unicornixa/tss-wf@0ec4ad0/js/logic/time-to-call-filter.js`)
  ])
    .then(() => {
      initEmailForm();
    })
